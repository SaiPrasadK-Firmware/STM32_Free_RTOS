...
/* RTOS objects --------------------------------------------------------------*/
osThreadId_t Task1HandlerHandle;
const osThreadAttr_t Task1Handler_attributes = {
  .name = "Task1Handler",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};

osThreadId_t Task2HandlerHandle;
const osThreadAttr_t Task2Handler_attributes = {
  .name = "Task2Handler",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
